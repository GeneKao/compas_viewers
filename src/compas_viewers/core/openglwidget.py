...
class OpenGLWidget(QtWidgets.QOpenGLWidget):
    ...
    def __init__(self, parent=None):
        super(OpenGLWidget, self).__init__(parent=parent)

        self._current_view = OpenGLWidget.VIEW_PERSPECTIVE
    ...
    def resizeEvent(self, event):
        super(OpenGLWidget, self).resizeEvent(event)
    ...
    def keyPressEvent(self, event):
        super(OpenGLWidget, self).keyPressEvent(event)
        key = event.key()
